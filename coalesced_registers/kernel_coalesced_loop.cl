...
#define LOOP_ITERS (ERT_FLOP/1024)
...
#if LOOP_ITERS > 1
  for (size_t l = 0; l < LOOP_ITERS; ++l)
  {
#endif

#if ((ERT_FLOP/LOOP_ITERS) & 1) == 1       /* add 1 flop */
      KERNEL1(beta,A[i],alpha);
#endif
#if ((ERT_FLOP/LOOP_ITERS) & 2) == 2       /* add 2 flops */
      KERNEL2(beta,A[i],alpha);
#endif
#if ((ERT_FLOP/LOOP_ITERS) & 4) == 4       /* add 4 flops */
      REP2(KERNEL2(beta,A[i],alpha));
#endif
#if ((ERT_FLOP/LOOP_ITERS) & 8) == 8       /* add 8 flops */
      REP4(KERNEL2(beta,A[i],alpha));
#endif
#if ((ERT_FLOP/LOOP_ITERS) & 16) == 16     /* add 16 flops */
      REP8(KERNEL2(beta,A[i],alpha));
#endif
#if ((ERT_FLOP/LOOP_ITERS) & 32) == 32     /* add 32 flops */
      REP16(KERNEL2(beta,A[i],alpha));
#endif
#if ((ERT_FLOP/LOOP_ITERS) & 64) == 64     /* add 64 flops */
      REP32(KERNEL2(beta,A[i],alpha));
#endif
#if ((ERT_FLOP/LOOP_ITERS) & 128) == 128   /* add 128 flops */
      REP64(KERNEL2(beta,A[i],alpha));
#endif
#if ((ERT_FLOP/LOOP_ITERS) & 256) == 256   /* add 256 flops */
      REP128(KERNEL2(beta,A[i],alpha));
#endif
#if ((ERT_FLOP/LOOP_ITERS) & 512) == 512   /* add 512 flops */
      REP256(KERNEL2(beta,A[i],alpha));
#endif
#if ((ERT_FLOP/LOOP_ITERS) & 1024) == 1024 /* add 1024 flops */
...
#endif
#if (ERT_FLOP & 4096) == 4096 // add 4096 flops
      REP2048(KERNEL2(beta,A[i],alpha));
#endif
#if (ERT_FLOP & 8192) == 8192 // add 8192 flops
