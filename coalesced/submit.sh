...
submit() {
    ...
    if [ -z "$gettimes" ]; then
        ...
        if [ -d /mnt/scratch/cmaclean/coalesced3/save/$name ]; then
            directory=/mnt/scratch/cmaclean/coalesced3/save/$name
        elif [ -d /mnt/scratch/cmaclean/coalesced2/save/$name ]; then
            directory=/mnt/scratch/cmaclean/coalesced2/save/$name
        elif [ -d /mnt/scratch/cmaclean/coalesced/save/$name ]; then
            directory=/mnt/scratch/cmaclean/coalesced/save/$name
        else
            echo "${name} not found"
            return
        fi
        ...
        mkdir -p /mnt/scratch/cmaclean/roofline_coalesced

        ln -snf $directory /mnt/scratch/cmaclean/roofline_coalesced/$name || true
